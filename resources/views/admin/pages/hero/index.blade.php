                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->image)
                                            <img src="{{asset('uploads/hero/'.$item->image)}}" alt="{{$item->title}}"
                                              width="80">
                                            @else
                                            No Image
                                            @endif
                                        ...
                                        {{-- <td>
                                            <a href="{{ route('heros.edit', $hero->id) }}" class="btn btn-sm
                                        btn-warning">Edit</a>
                                        <form action="{{ route('heros.destroy', $hero->id) }}" method="POST"
