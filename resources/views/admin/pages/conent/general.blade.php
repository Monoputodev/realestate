                            ...
                            <form method="POST" action="{{ route('general.update', $content->id) }}"
                              enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="title" class="form-label">Portfolio intro</label>
                                        <input type="text" class="form-control" id="title" name="website_intro"
                                          value="{{ $content->website_intro }}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="subtitle" class="form-label">Portfolio Description</label>
                                        <input type="text" class="form-control" id="subtitle" name="website_description"
                                          value="{{ $content->website_description }}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="image" class="form-label">Portfolio Logo</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="image" class="form-label">Portfolio Favicon</label>
