        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('news.create') }}">
                + Create New News </a>
              ...
              <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @if ($news->image)
                      <img src="{{ asset('uploads/news/' . $news->image) }}" alt="{{ $news->title }}" width="80">
                      @else
                      No Image
                      @endif
                    </td>
                    ...
                    <td>
                      ...
                      <a class="btn btn-danger waves-effect btn-circle waves-light"
                        href="{{ route('news.inactive', $news->id) }}">
                      ...
                      <form hidden action="{{ route('news.destroy', $news->id) }}" id="form{{ $news->id }}"
                        method="get">
                        @csrf
                      </form>
                      <button class="btn btn-danger waves-effect btn-circle waves-light"
                        onclick="deleteItem({{ $news->id }});" type="button">
                        <i class="fa fa-trash"></i> </button>
                    </td>
                    {{-- <td>
                                            <a href="{{ route('news.edit', $news->id) }}" class="btn btn-sm
                    btn-warning">Edit</a>
