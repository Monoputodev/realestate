                            ...
                            <form method="POST" action="{{ route('projects.update',$project->id) }}"
                              enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="service" class="form-label">Subtitle</label>
                                        <input type="text" class="form-control" id="service" name="service"
                                          value="{{ $project->service }}" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="{{ $project->apartment_size }}" class="form-control"
                                          id="apartment_size" name="apartment_size">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="summernote" type="text" class="form-control" id="experience"
                                          name="experience">{!!$project->experience !!}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="features" class="form-label">Features</label>
                                        <textarea id="summernote1" type="text" class="form-control" id="features"
                                          name="features">
                                          {!!$project->features !!}
                                    </textarea>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="summernote2" type="text" class="form-control" id="floor_plan"
                                          name="floor_plan">
