            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Property Type</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger waves-effect btn-circle waves-light"
                                              href="{{ route('propertytypes.inactive', $propertytype->id) }}">
                                                <i class="fa fa-eye-slash"></i> </a>
                                            @else
                                            <a class="btn btn-success waves-effect btn-circle waves-light"
                                              href="{{ route('propertytypes.active', $propertytype->id) }}">
                                                <i class="fa fa-eye"></i> </a>
                                            @endif

                                            <a class="btn btn-primary waves-effect btn-circle waves-light"
                                              href="{{ route('propertytypes.edit', $propertytype->id) }}">
                                                <i class="fa fa-edit"></i> </a>
                                            <form hidden action="{{ route('propertytypes.destroy', $propertytype->id) }}"
                                              id="form{{ $propertytype->id }}" method="get">
                                                @csrf
                                            </form>
                                            <button class="btn btn-danger waves-effect btn-circle waves-light"
                                              onclick="deleteItem({{ $propertytype->id }});" type="button">
