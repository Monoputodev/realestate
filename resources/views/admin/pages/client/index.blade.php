                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger waves-effect btn-circle waves-light"
                                              href="{{ route('clients.inactive', $client->id) }}">
                                                <i class="fa fa-eye-slash"></i> </a>
                                            @else
                                            <a class="btn btn-success waves-effect btn-circle waves-light"
                                              href="{{ route('clients.active', $client->id) }}">
                                            ...
                                            <form hidden action="{{ route('clients.destroy', $client->id) }}"
                                              id="form{{ $client->id }}" method="get">
                                                @csrf
                                            </form>
                                            <button class="btn btn-danger waves-effect btn-circle waves-light"
                                              onclick="deleteItem({{ $client->id }});" type="button">
                                                <i class="fa fa-trash"></i> </button>
                                        </td>
                                        {{-- <td>
                                            <a href="{{ route('clients.edit', $client->id) }}" class="btn btn-sm
                                        btn-warning">Edit</a>
